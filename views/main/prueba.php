...
.video-container {
    ...
    left: 50%;
    transform: translate(-50%, -50%);
    width: 100%; /* Ancho del contenedor de video */
    height: 100%; /* Altura del contenedor de video */
    border-radius: 20px; /* Bordes redondeados */
...
.close-btn {
    ...
    font-size: 15px;
    cursor: pointer;
    z-index: 10000; /* Asegura que esté por encima del video */
}
    </style>
...
const previews = document.querySelectorAll('.carousel-item .preview');
const playIcons = document.querySelectorAll('.carousel-item .play-icon');
const closeButtons = document.querySelectorAll('.carousel-item .close-btn');
...
// Mostrar la ventana emergente cuando se hace clic en el icono de reproducción
playIcons.forEach((playIcon, index) => {
    playIcon.addEventListener('click', function() {
        const videoPopup = playIcon.closest('.carousel-item').querySelector('.video-popup');
...
closeButtons.forEach((closeButton) => {
    closeButton.addEventListener('click', function() {
        const videoPopup = closeButton.closest('.video-popup');
        videoPopup.style.display = 'none';
        const video = videoPopup.querySelector('video');
        video.pause(); // Pausar el video al cerrar la ventana emergente
    });
});
