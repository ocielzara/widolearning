            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div class="app-container container-xxl">
                    ...
                    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                        ...
                        <div class="d-flex flex-column flex-column-fluid" style="text-align: center;">
                            <!--begin::Content-->
                            <div id="kt_app_content" class="app-content">
                                <?php
                                // Verificar si el correo está presente en la URL
                                if (isset($_GET['correo'])) {
                                    $correo = $_GET['correo'];
                                    echo "<p style=" . "font-size: 140%;" . ">Ingrese el código recibido en el correo asociado a la dirección: $correo</p>";
                                } else {
                                    // Manejar el caso en el que no se proporciona el correo electrónico
                                    echo "<p>Error: No se especificó el correo electrónico.</p>";
                                }
                                ?>
                                ...
                                <form action="index.php?c=rcontraseña&a=cambio_contraseña" method="post">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 fv-row" style="margin-left:50%;">
                                                <input type="number" id="codigo" name="codigo" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" required />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                    ...
                                    <?php
                                    // Incluir un campo oculto para enviar el correo nuevamente al procesar el formulario
                                    if (isset($correo)) {
