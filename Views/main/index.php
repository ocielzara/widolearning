            ...
            <div class="flex my-10">
                <div class="py-10 sm:px-5 px-0 xl:mx-32 md:mx-16 swiper">
                   ...
                   <div class=" my-10 inline-block">
                    ...
                    <div class=" my-10 inline-block">
                        <h1 class="border-b-2 border-[#4F7CAC] sm:text-start text-center 2xl:text-5xl lg:text-2xl text-3xl sm:ml-20 font-bold py-3 text-[#4F7CAC]">
                            PROGRAMACION
                        </h1>
                    </div>
                    <div class="flex my-10">
                    ...
                    <div class=" my-10 inline-block">
                        <h1 class="border-b-2 border-[#4F7CAC] sm:text-start text-center lg:text-4xl text-3xl sm:ml-20 font-bold py-3 text-[#4F7CAC]">
                            OTROS
                        </h1>
                    </div>
                    <div class="flex my-10">
