...
<body>
    ...
    <div class="container-form sign-up">
        <form class="formulario" method="post" id="editFormAdmi">
            <div class="left-content">
                <h2 class="create-account">Editar usuario</h2>
                <div class="flex flex-col mb-8">
                    <input class="datos" id="nombreUsuarioAd" type="text" name="nombre" placeholder="Nombre completo">
                    <span id="nombre-error" class="error-message text-red-600 text-base mt-2"></span>
                </div>
                <div class="flex flex-col mb-8">
                    <input class="datos" id="edadUsuarioAd" type="text" name="edad" placeholder="Edad">
                    <span id="edad-error" class="error-message text-red-600 text-base mt-2"></span>
                </div>
                <div class="flex flex-col mb-8">
                    <input class="datos" id="correoUsuarioAd" type="email" name="email" placeholder="Correo electronico">
                    <span id="correo-error" class="error-message text-red-600 text-base mt-2"></span>
                </div>
                <div class="flex flex-col mb-8">
                    <input class="datos" id="telefonoUsuarioAd" type="text" name="telefono" placeholder="Whatsapp" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
