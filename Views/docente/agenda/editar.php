...
$id_disponibilidad = $_GET['id'];?>
  ...
  <div class="container">
    <div class="text-center mb-4">
      <h3>Editar agenda</h3>
      <p class="text-muted">Click en actualizar despues de cambiar cualquier informacion</p>
    </div>

    <div class="container d-flex justify-content-center">
      <form action="index.php?c=Docentes&a=actualizarDisponibilidad" method="post"  style="width:50vw; min-width:300px;">
        <div class="row mb-3">
          <div class="col">
