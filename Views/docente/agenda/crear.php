...
<style>
	 * {
        ...
        body {
            ...
            font-weight: bold; /* Hace el tipo de letra más grueso */
   ...
   .container {
    max-width: 850px; /* Ajusta el ancho máximo según sea necesario */
...
input[type="date"] {
    width: 20%; /* Ancho del input al 100% */
    border-radius: 15px; /* Bordes redondeados */
}
...
<div class="container">
   <form class="formulario" action="index.php?c=Docentes&a=agendaCrear" method="post">
      <div class="row mb-3">
         <div class="col">
