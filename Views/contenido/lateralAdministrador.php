            ...
            <div>
                ...
                <div class="nav__list">
                    <div class="nav__items">
                        <a href="index.php?c=Administradors&a=vistaAsignaciones&id=<?php echo $_SESSION['id_usuario']; ?>" class="nav__link">
                            <i class='bx bx-collection nav__icon'></i>
                            <span class="nav__name">Asignacion</span>
                        </a>
                            ...
                            <a href="index.php?c=Administradors&a=vistaInscripciones&id=<?php echo $_SESSION['id_usuario']; ?>" class="nav__link">
                                <i class='bx bx-book-open nav__icon'></i>
                                <span class="nav__name">Inscripcion</span>
                            </a>
                            
                            <a href="index.php?c=Administradors&a=vistaMentores&id=<?php echo $_SESSION['id_usuario']; ?>" class="nav__link">
                                <i class='bx bx-user-circle nav__icon'></i>
                                <span class="nav__name">Mentor</span>
                            </a>
                            
                            <a href="index.php?c=Administradors&a=vistaUsuarios&id=<?php echo $_SESSION['id_usuario']; ?>" class="nav__link">
                                <i class='bx bx-user-circle nav__icon'></i>
                                <span class="nav__name">Usuario</span>
                            </a>
                            
                            <a href="index.php?c=Administradors&a=vistaAprendizajes&id=<?php echo $_SESSION['id_usuario']; ?>" class="nav__link">
                                <i class='bx bx-book-content nav__icon'></i>
                                <span class="nav__name">Aprendizaje</span>
                            </a>
