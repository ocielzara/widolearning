...
.nav__iconSub {
 ...
 .contenedor-iconos {
        margin-top: -4rem; /* Ajusta este valor para mover los íconos hacia arriba o hacia abajo */
            ...
            <div class="flex flex-col h-full relative sm:top-0 top-48">
                ...
                <div class="sm:h-1/3 2xl:text-[2.5rem] xl:text-[2.6rem] text-2xl">
                    <div class="sm:w-[29rem] sm:mx-36 xl:mx-28 2xl:mx-36 2xl:mt-0 xl:mt-10">
                        <h1 id="curso-nombre" class="sm:font-bold text-[#4F7CAC]">Curso:</h1>
                        <h1 id="mentor-nombre" class="sm:mt-12 mt-3 sm:font-medium font-bold xl:text-4xl text-[#000000]">Mentor:</h1>
                        <h1 id="total-creditos" class="sm:mt-12 mt-3 sm:font-medium font-bold xl:text-4xl text-[#000000]">Total créditos:</h1>
                        <h1 id="cursados" class="sm:mt-12 mt-3 sm:font-medium font-bold xl:text-4xl text-[#000000]">Cursados:</h1>
